...
class DataAtts():
    def __init__(self, file_name):
        ...
        elif file_name == "original_data/cancer_escalonated.csv":
            self.message = "Breast Cancer Wisconsin (Diagnostic) Data Set eSCALONATED 1"
            self.class_name = "diagnosis"
            self.values_names = {0: "Benign", 1: "Malignant"}
            self.class_len = 31
            self.fname="cancer_escalonated"
        ...
        elif file_name == "original_data/prueba_escalonated.csv":
            self.message="Pima Indians Diabetes Database eSCALONATED 1"
            self.class_name = "Outcome"
            self.values_names = {0: "Normal", 1: "Diabets"}
            self.class_len = 9
            self.fname="prueba_escalonated"
